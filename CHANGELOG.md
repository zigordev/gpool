...
* **rum:** record real visits again ([#259](https://github.com/zigordev/gpool/issues/259)) ([c343e0d](https://github.com/zigordev/gpool/commit/c343e0da54c185ed73dc9a8557473a72538edb19))
...
* **ci:** stop format:check from gating on the generated changelog ([#242](https://github.com/zigordev/gpool/issues/242)) ([1bba60d](https://github.com/zigordev/gpool/commit/1bba60df05a1883b2ed2e6e73345ef25252cd760))


### Refactoring

* **scripts:** one local-stack body with a per-repo config block ([#241](https://github.com/zigordev/gpool/issues/241)) ([6cb1187](https://github.com/zigordev/gpool/commit/6cb118797dea5ea849f4bd928c0b8a1eb7b4dcef))
* **scripts:** one shared body for the audit gate and licence check ([#239](https://github.com/zigordev/gpool/issues/239)) ([1aba103](https://github.com/zigordev/gpool/commit/1aba10359c7f1077e23155092f368c0dc85aa245))
* **shape:** converge compose conventions, drop the terraform stub and add the web health route ([#238](https://github.com/zigordev/gpool/issues/238)) ([c891e48](https://github.com/zigordev/gpool/commit/c891e48e017b4171321530ad0ac200ec8644acb7))
* **web:** rename apps/ui to apps/web ([#231](https://github.com/zigordev/gpool/issues/231)) ([79e0572](https://github.com/zigordev/gpool/commit/79e0572227765c5e12cf4a2a318f92602cb8683d))
...
- auth issue ([#39](https://github.com/zigorlsp7/gpool/issues/39)) ([f96de0a](https://github.com/zigorlsp7/gpool/commit/f96de0a998434531197dc6a0472a4d93b0d813fd))
...
- dockerfiles ([#18](https://github.com/zigorlsp7/gpool/issues/18)) ([bdd706e](https://github.com/zigorlsp7/gpool/commit/bdd706e2f46d72bac95dce4a28cdcfb434cd00c9))

## [0.1.2](https://github.com/zigorlsp7/gpool/compare/v0.1.1...v0.1.2) (2026-03-10)

### Bug Fixes

- **deploy:** accept NEXT_PUBLIC_API_BASE_URL alias ([#13](https://github.com/zigorlsp7/gpool/issues/13)) ([c8300f9](https://github.com/zigorlsp7/gpool/commit/c8300f95352fb5e193be17ffb81360677df22a81))

## [0.1.1](https://github.com/zigorlsp7/gpool/compare/v0.1.0...v0.1.1) (2026-03-10)

### Features

- auth service ([d6b7eda](https://github.com/zigorlsp7/gpool/commit/d6b7edaaea8007158113180ae4a070373b626219))

### Bug Fixes

- **ci:** harden runtime images and pass trivy scan ([cc4fdcc](https://github.com/zigorlsp7/gpool/commit/cc4fdcc075638957669f2839ff4a2d3d9c95f642))
- **ci:** provide openbao vars for compose validation ([c80f0d9](https://github.com/zigorlsp7/gpool/commit/c80f0d912fbd017553d8bf24239d9d999d62a723))
- **ci:** stabilize trivy scan and include web local translations ([a080385](https://github.com/zigorlsp7/gpool/commit/a0803853363d8326b6fcec1f92647743ac641b70))
- **ci:** unblock audit gate and expand gpool checks ([96f94fd](https://github.com/zigorlsp7/gpool/commit/96f94fdfca95f9f0b761d14c566fda42e95fe80b))
- **ui:** use secure random for rum session id ([897441a](https://github.com/zigorlsp7/gpool/commit/897441a23f512c1c71f307c1366d6c4a98514711))
