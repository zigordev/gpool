...
class PrizePayoutDto {
  ...
  @ApiPropertyOptional({
    description: 'Fixed prize amount paid to this ranking position',
    example: 75,
  })
  @IsOptional()
  @IsNumber()
...
class PrizeDistributionDto {
  ...
  @ApiProperty({
    type: [PrizePayoutDto],
    description: 'Fixed prize amounts by arbitrary ranking position',
  })
  @IsArray()
...
class PlayerScoringDto {
  ...
  @ApiProperty({
    description: 'Points for a missed penalty during a penalty shootout',
    example: -1,
  })
  @IsNumber()
  ...
  @ApiProperty({
    description: 'Points for forcing a penalty miss during a penalty shootout',
    example: 5,
  })
  @IsNumber()
...
export class PoolConfigDto {
  ...
  @ApiPropertyOptional({
    description:
      'Pool-wide prediction deadline (epoch milliseconds). Once passed, no predictions or bracket picks can be made or edited.',
...
export class CreatePoolDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Season-long pool for Premier League',
    maxLength: 500,
  })
  @IsOptional()
  @IsString()
